...
<table id="single_survey_table" class="table table-striped table-bordered kotw_survey_table">
    <thead>
        <tr>
            <th>
                User ID
...
<?php
            ...
            foreach ($answers_query_results as $survey_item) { 
                ...
                ?>
                <tr>
                    <td><a href="<?php echo get_edit_user_link($survey_item['user_id']); ?>" target="_blank"><?php echo $user_data->display_name; ?></a></td>
                    <td>
