 ...
 *
 * Be sure to replace all instances of 'survey_' with your project's prefix.
 ...
 */
function survey_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function survey_hide_if_no_cats( $field ) {
 ...
 */
function survey_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function survey_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function survey_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'survey_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function survey_register_demo_metabox() {
	/**
	 * Sample metabox to demonstrate each field type included
	 */
	$cmb_demo = new_cmb2_box( array(
		'id'            => 'survey_demo_metabox',
		'title'         => esc_html__( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'survey' ), // Post type
		// 'show_on_cb' => 'survey_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'survey_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'survey_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'survey_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'survey_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'survey_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'survey_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'survey_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'survey_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'survey_demo_taxonomy_select',
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'survey_demo_embed',
		'type' => 'oembed',
	) );

	$cmb_demo->add_field( array(
		'name'         => 'Testing Field Parameters',
		'id'           => 'survey_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'survey_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'survey_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function survey_register_about_page_metabox() {

	/**
	 * Metabox to be displayed on a single page ID
	 */
	$cmb_about_page = new_cmb2_box( array(
		'id'           => 'survey_about_metabox',
	...
	$cmb_about_page->add_field( array(
		'name' => esc_html__( 'Test Text', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_about_text',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'survey_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function survey_register_repeatable_group_field_metabox() {

	/**
	 * Repeatable Field Groups
	 */
	$cmb_group = new_cmb2_box( array(
		'id'           => 'survey_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'survey_group_demo'
	$group_field_id = $cmb_group->add_field( array(
		'id'          => 'survey_group_demo',
		'type'        => 'group',
...
add_action( 'cmb2_admin_init', 'survey_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function survey_register_user_profile_metabox() {
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_user_user_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'survey_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function survey_register_taxonomy_metabox() {
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'survey_term_term_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'survey_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function survey_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'survey_theme_options_page',
		...
		'option_key'      => 'survey_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'survey_options_page_message_callback',
 ...
 * }
 */
function survey_options_page_message_callback( $cmb, $args ) {
 ...
 */
function survey_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'survey_register_rest_api_box' );
/**
 ...
 */
function survey_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		'id'            => 'survey_rest_metabox',
		...
		// 'get_box_permissions_check_cb' => 'survey_limit_rest_view_to_logged_in_users',
	) );
