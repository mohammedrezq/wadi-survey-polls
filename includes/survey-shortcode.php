...
?>
						...
						?>
							...
							<div class="matrix_table_container">
								<table>
									<thead>
										<tr>
											<th><?php esc_html_e('Questions', 'wadi-survey'); ?></th>
											<?php
	...
	<?php
		 ...
		 */
	?>
		<form id="multistep_survey" method="POST" class="survey_multistep_container" data-survey-id="<?php echo $the_post_id; ?>" data-user-id="<?php echo $the_current_user_id; ?>" data-post-type="<?php echo get_post_type($the_post_id); ?>">
			<?php
			$survey_items = carbon_get_post_meta($the_post_id, 'survey_items');
	...
	?>
		<form method="POST" class="survey_container" data-survey-id="<?php echo $the_post_id; ?>" data-user-id="<?php echo $the_current_user_id; ?>" data-post-type="<?php echo get_post_type($the_post_id); ?>">
				...
				?>
						...
						?>
							<div class="dropdown_question_container">
								...
								<div class="custom-control custom-select">
									<select name="<?php echo $dropdownQuestion; ?>" id="id_<?php echo $theQuestionCleaned; ?>">
										<option value=""><?php esc_html_e('Select Option', 'wadi-survey') ?></option>
			...
			<button type="submit" class="wadi_survey_submit"><?php esc_html_e('Submit', 'wadi-survey'); ?></button>
		</form>
		<input type="hidden" data-survey-finish-message='<?php echo $survey_finish_message; ?>' 
		data-redirect-time="<?php echo $redirect_time; ?>" data-survey-already-taken-message='<?php echo $survey_already_taken_message; ?>' class="redirect_url" data-redirect-url='<?php echo $redirect_url; ?>' />
	<?php
	...
	?>
		<form id="multistep_survey" method="POST" class="survey_multistep_container" data-survey-id="<?php echo $the_post_id; ?>" data-user-id="<?php echo $the_current_user_id; ?>" data-post-type="<?php echo get_post_type($the_post_id); ?>">
			...
			<div style="overflow:auto;">
				<div class="multistep_naviation" style="float:right;">
					<button type="button" id="prevBtn"><?php esc_html_e('Previous', 'wadi-survey'); ?></button>
					<button type="button" id="nextBtn"><?php esc_html_e('Next', 'wadi-survey'); ?></button>
				</div>
			</div>
		</form>
		<input type="hidden" data-survey-finish-message='<?php echo $survey_finish_message; ?>' 
