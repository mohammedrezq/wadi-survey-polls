...
class WadiEnqueue
{
    ...
    public function poll_backend_init($hook)
    {
        ...
        wp_enqueue_style('poll_styles', plugins_url('assets/dist/poll-admin.css', realpath(__DIR__)), false, time(), 'all');
        wp_enqueue_script('poll_js_backend', plugins_url('assets/dist/poll-admin.js', realpath(__DIR__)), array('jquery'), time(), true);
    }
}
