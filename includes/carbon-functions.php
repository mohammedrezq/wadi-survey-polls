 ...
 */
 ...
 function survey_elements() {
    ...
    $survey_item_label = array(
     ...
     Container::make( 'post_meta', __('Survey', 'survey') )
     ->where( 'post_type', '=', 'survey' )
     ->add_fields( array(
         Field::make( 'complex', 'survey_items', 'Survey Items' )
         ->setup_labels( $survey_item_label )
         ->add_fields( array(
             Field::make( 'select', 'select_survey_question_type', __( 'Survey Question Types' ) )
             ->set_options( array(
            ...
            Field::make( 'complex', 'single_answers', 'Answers' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array(
                    'field' => 'select_survey_question_type',
            ...
            ->add_fields( array (
                Field::make( 'text', 'single_text_answers', __('Answers') )
            ) ),
            /**
             * Multiple Answers Question Survey Item
             */
            Field::make( 'rich_text', 'multiple_question', 'Question' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array(
                    'field' => 'select_survey_question_type',
            ...
            Field::make( 'complex', 'multiple_answers', 'Answers' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array(
                    'field' => 'select_survey_question_type',
            ...
            ->set_layout('tabbed-vertical')
            ->add_fields( array (
                Field::make( 'text', 'multiple_text_answers', __('Answers') )
            ) ),
            /**
             * Martix Questions Survey Item
             */
            Field::make( 'rich_text', 'matrix_statement', 'Statement' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array(
                    'field' => 'select_survey_question_type',
                ...
                Field::make( 'complex', 'matrix_questions_array', __('Questions Column') )
                ->set_conditional_logic( array(
                    'relation' => 'AND',
                    array(
                        'field' => 'select_survey_question_type',
                        ...
                        ->set_layout('tabbed-vertical')
                        ->add_fields( array (
                            Field::make( 'text', 'matrix_text_questions', __('Question Field') ),
                            ) )
                        ->set_header_template( '
                            ...
                            <% } %>
                        ' ),
            Field::make( 'complex', 'matrix_answers_array', __('Answers Columns') )
            ->setup_labels( $label_answers )
            ->set_layout('tabbed-horizontal')
            ->add_fields( array (
            Field::make( 'text', 'matrix_answer_text', __('Answers') )
            ) )
            ->set_header_template( '
             ...
             */
            Field::make( 'rich_text', 'textarea_question', 'Textarea Question' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array(
                    'field' => 'select_survey_question_type',
