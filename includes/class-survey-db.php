...
class WadiSurveyDB
{
    ...
    public function getPollData()
    {
        ...
        if (isset($_POST['data']) && !empty($_POST['data'])) {
            $userID = intval($_POST['data']['user_id']);
            $pollID = intval($_POST['data']['poll_id']);
            $pollData = sanitize_text_field($_POST['data']['pollData']);
            ...
            $allow_multiple_responses_poll =  carbon_get_post_meta($pollID, 'wadi_poll_multiple_responses');
